      ...
      <Swiper pagination={true} modules={[Pagination]} className="mySwiper">
        <SwiperSlide>
          <div className="relative">
            <img src={assets.assetImg10} alt="assetImg10" className="w-full object-cover h-[50vh] lg:h-full" />
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 bg-black/40 dark:bg-black/60">
              ...
              <p className="text-white font-medium text-sm sm:text-base md:text-lg lg:text-xl mb-4 dark:text-gray-00 uppercase ">
                New Era Of Luxury Fitness
              </p>

              <button className="bg-white text-black text-sm sm:text-base px-4 sm:px-6 py-2 sm:py-3 transition hover:bg-black  dark:hover:text-black dark:hover:bg-white dark:text-white dark:bg-black hover:text-white uppercase font-semibold cursor-pointer">
                Know More
              </button>
            </div>
        ...
        <SwiperSlide>
          <div className="relative">
            <img src={assets.assetImg9} alt="" className="w-full object-cover h-[50vh] lg:h-full" />
        ...
        <SwiperSlide>
          <div className="relative">
            <img src={assets.assetImg2} alt="" className="w-full object-cover h-[50vh] lg:h-full" />
        ...
        <SwiperSlide>
          <div className="relative">
            <img src={assets.assetImg5} alt="" className="w-full object-cover h-[50vh] lg:h-full" />
        ...
        <SwiperSlide>
          <div className="relative">
            <img src={assets.assetImg6} alt="" className="w-full object-cover h-[50vh] lg:h-full" />
        ...
        <SwiperSlide>
          <div className="relative">
            <img src={assets.assetImg1} alt="" className="w-full object-cover h-[50vh] lg:h-full" />
        ...
        <SwiperSlide>
          <div className="relative">
            <img src={assets.assetImg8} alt="" className="w-full object-cover h-[50vh] lg:h-full" />
